...
export const featuresData = [
    {
        ...
        title: 'Smart Upload',
        desc: 'Drag & drop your assests. We aut-optimize formats and sizes'
    },
    {
        icon: <ZapIcon className="w-6 h-6" />,
        title: 'Instant Generation',
        desc: 'Optimized models deliver ouput in seconds with great fidelity'
    },
    {
...
export const faqData = [
    ...
    },
    {
        ...
        answer: 'Yes - you can cancel from your dashboard. You will retain access through the end of your biling period.'
    },
    {
