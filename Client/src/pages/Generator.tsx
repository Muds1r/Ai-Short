          ...
          <div className="w-full text-gray-300">
            ...
            <div className="mb-4 text-gray-300">
              ...
              <div className="flex gap-3">
                <RectangleVerticalIcon onClick={(e) => setAspectRatio('9:16')} className={`p-2.5 size-13 bg-white/6 rounded transition-all ring-2 ring-transparent cursor-pointer ${aspectRatio === '9:16' ? 'ring-violet-500/50 bg-white-10' : ''}`} />
                <RectangleHorizontalIcon onClick={(e) => setAspectRatio('16:9')} className={`p-2.5 size-13 bg-white/6 rounded transition-all ring-2 ring-transparent cursor-pointer ${aspectRatio === '16:9' ? 'ring-violet-500/50 bg-white-10' : ''}`} />
              </div>
            </div>
